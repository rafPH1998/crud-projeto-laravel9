    ...
    <tbody>
        @forelse($users as $user)
            <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <a href="{{ route('users.edit', $user->id) }}" class="bg-green-200 rounded-full py-2 px-6 hover:bg-green-300">Editar</a>
                </td>
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <a href="{{ route('comments.index', $user->id) }}" class="bg-blue-200 rounded-full py-2 px-6 hover:bg-blue-300">Anotações ({{ $user->comments->count() }})</a>
                </td>
            </tr>
        @empty
          <tr>
